...
public class PrefacturasController {
  ...
  private String MENSAJE_FORM2 = "¡Prefactura guardada con éxito, redireccionando a la prefactura guardada!";
  
  private String MENSAJE_FORM3 = "¡Solo se pueden guardar si el tipo de documento corresponde a una prefactura!";
